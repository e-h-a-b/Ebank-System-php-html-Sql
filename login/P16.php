  ...
  <body class="nav-sm">
    <div class="container body">
     ...
     <?php include('Sidemenu.php'); ?>
        ...
        <!-- page content -->
        <div class="right_col" role="main" style="min-height: 722px;">          <!-- top tiles -->
    ...
    $(this).prop('Counter',0).animate({
        ...
        step: function (now) {
         ...
         <div class="col-md-12" dir="rtl">
                <div class="x_panel">
                  <div class="x_title">
                    <h>Typography <small>different design elements</small></h>
                   
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content" style="display: block; width: 100%;">

          <img src="http://ebank.esy.es/login/Gentallela%20Alela!%20__files/card.png" class="article-img" alt="" title="">          
...
size:13;
  ...
  text-shadow: 2px 2px 5px gray;
		  ...
		  <div style="position:absolute;left: 500px;top: 450px;width:30px;height:150;right: 0px;bottom: 0px;">
<div class="example-date">
<font size="12"><span class="yea" style="color: rgba(134, 169, 179, 0.52);position:absolute;left:130px;top: 150px;width:30px;height:150;size:6;"><?php $userRow['cardnum']; ?></span>
</font>
</div>
</div>
		  
		  <div style="position:absolute;left: 0px;top: 450px;width:30px;height:150;right: 0px;bottom: 0px;">
<div class="example-date">
<font size="4">
<span class="year" style="color: rgb(0, 0, 0);position:absolute;left:130px;top: 50px;width:30px;height:150;size:2px;"><?php $userRow['cardnum']; ?></span>
</font>
</div>
</div>
		  
		  <div style="position:absolute;left: 100px;top: 600px;width:30px;height:150;right: 0px;bottom: 0px;">
<div class="example-date">
<font size="4"><span class="yu" style="/* color: rgb(56, 1, 1); */position:absolute;left: 600px;top: 50px;width:30px;height:150;size:2px;">00/00</span>
</font>
</div>
</div>
		  
		  <div style="position:absolute;left: 300px;top: 600px;width:30px;height:150;right: 0px;bottom: 0px;">
<div class="example-date">
<font size="4"><span class="yu" style="/* color: rgb(56, 1, 1); */position:absolute;left: 600px;top: 50px;width:30px;height:150;size:2px;">ebank</span>
</font>
</div>
</div>
