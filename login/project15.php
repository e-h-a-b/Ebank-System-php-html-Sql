...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title" dir="rtl">
                    <h> انشاء مشروع<small>اسواق تابعة للبنك</small></h>
                  ...
                  <!-- Smart Wizard -->
                    ...
                    <div id="wizard" class="form_wizard wizard_horizontal">
                      <ul class="wizard_steps anchor">
						...
						<li>
                          <a href="http://ebank.esy.es/login/project15.php#step-6" class="disabled" isdone="0" rel="6">
                         ...
                         <li>
                          <a href="http://ebank.esy.es/login/project15.php#step-5" class="disabled" isdone="0" rel="5">
						...
						<li>
                          <a href="http://ebank.esy.es/login/project15.php#step-4" class="disabled" isdone="0" rel="4">
						 ...
						 <li>
                          <a href="http://ebank.esy.es/login/project15.php#step-3" class="disabled" isdone="0" rel="3">
						...
						<li>
                          <a href="http://ebank.esy.es/login/project15.php#step-2" class="disabled" isdone="0" rel="2">
						...
						<li>
                          <a href="http://ebank.esy.es/login/project15.php#step-1" class="selected" isdone="1" rel="1">
	   ...
	   $qp = mysql_query("SELECT * FROM addproject WHERE  pernu='15'");
 $qlll =mysql_query("SELECT proj FROM astbyan WHERE nu='15'");
...
<tr>
  ...
  <?php    
 $fill= mysql_query("SELECT * FROM price WHERE  pro='15' and idpro='".$rpoo['idcode']."' and kind='A' ");
...
<tr>
    ...
    <th class="tg-6nwz">سابق</th>
     ...
     <?php    
 $fil= mysql_query("SELECT * FROM price WHERE  pro='15' and idpro='".$rpoo['idcode']."' and kind='B' ");
...
<table class="tg">
  ...
  <tr>
    ...
    <th class="tg-6nwz">م</th>
     ...
     <?php    
 $fi= mysql_query("SELECT * FROM salary WHERE  pro='15' and idpro='".$rpoo['idcode']."'  ");
...
if($code==$rpoo['idcode']){
			   $code=$rpoo['idcode'];
	$se=mysql_query("SELECT `perid`,`procode` FROM `userpor` WHERE `perid`='".$userRow['userId']."' And `procode`='$code' And pronum='15'");
...
?>
	  <form id='myform' action='insertpro.php' method="post">
						...
						<input type ="text" name="codenm" maxlength="3" style="display:none;" placeholder="قم بإدخال المبلغ"  value="15"  >
