        ...
        <div class="right_col" role="main" style="min-height: 1732px; ">          <!-- top tiles -->
         <?php include('stripuser.php'); ?>
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Put Your money On Huge Project</h2>
...
<div class="x_content" style="display: block;">
                    ...
                    <div class="row">
                      ...
                      <p>Let of Huge Project</p>

                      <div class="col-md-55">
                        <div class="thumbnail">
                          <div class="image view view-first">
                            <img style="width: 100%; display: block;" src="https://k2partnering.com/wp-content/uploads/2018/05/Project-Management.jpg" alt="image">
                            <div class="mask">
                              <p>Steel Factory</p>
                          ...
                          <div class="caption">
                            <p>Name of project : Steel Factory</p>
							<p>Request money : 300 milion L.E.</p>
							<p>Personal Number : 1000 Per.p </p>
                          </div>
                        </div>
                      </div>
...
.thumbnail { 
    background-color: #274c67 !important;
    border: 1px solid #162831 !important;
