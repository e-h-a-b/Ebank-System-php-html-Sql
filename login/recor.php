...
<html lang="en" class=" "><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 <?php
	 ...
	 if(isset($_POST['submit']))
    {
     ...
     $username = "u856423732_egyba";
     $password = "9874123951753";
	 ...
	 $text=$_POST['text'];
	$sql = "UPDATE users SET Balance=Balance-".$text." WHERE userId='1'";
	 $date = date('Y-m-d H:i:s');
  
	 
	 

    //$ym = "UPDATE indx SET project1="$text" WHERE userid='1'";
		
			//	$sql = mysql_query("INSERT INTO `indx` (`email`,`userid`,`card_num`, `pass`, `project1`, `tim1`) VALUES('$email','$userid','$card_num', '$pass', '$text', '$date')");
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col" style="right: 0px;left: 30%;width: 900px;">
        ...
        <!-- page content -->
        <div class="right_col" role="main" style="min-height: 1169px;margin-right: 0px;margin-left: 0px;height: 1150px;width: 190%;">          <!-- top tiles -->
          <div class="x_panel">
                  <div class="x_title">
                    <h2>حجز تذكرة <small>عدد التذاكر</small></h2>
                  ...
                  <div class="x_content" style="display: block;">
                    ...
                    <form class="form-horizontal form-label-left input_mask">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" placeholder="اسمـــك">
                        <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control" id="inputSuccess3" placeholder="اسـم العائلة">
                        <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess4" placeholder="الايميــل">
                        <span class="fa fa-envelope form-control-feedback right" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control" id="inputSuccess5" placeholder="الهاتــف/المحمول">
                        <span class="fa fa-phone form-control-feedback right" aria-hidden="true"></span>
                      </div>

                      <div class="form-group"> 
					  <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" placeholder="أدخل سكنك">
                        </div>
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">منطقة السكن</label>
                       
                      </div>
                      <div class="form-group">
					   <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" readonly="readonly" placeholder="هذا هو التعريف الخاص بك">
                        </div>
					  ...
					  <div class="form-group">
					   <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" disabled="disabled" placeholder="رقم البنك الخاص بك">
                        </div>
                      ...
                      <div class="form-group">
					  <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control"  placeholder="ادخل البطاقة الشخصية">
                        </div>
					  ...
					  <div class="col-md-9 col-sm-9 col-xs-12">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">تاريخ الميلاد <span class="required">*</span>
                        </label>
...
<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="col-md-3 left_col" style="right: 0px;left: 130%;width: 900px;">
