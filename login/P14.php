    ...
    $(this).prop('Counter',0).animate({
        ...
        step: function (now) {
			...
			<div class="col-md-12 col-sm-12 col-xs-12" dir="rtl">
                <div class="x_panel">
                  <div class="x_title">
                    <h dir="rtl">سجل الايداعات المالية الخاص بك <small>عبر الاكود</small></h>
...
<table id="datatable-buttons" class="table table-striped jambo_table bulk_action" role="grid" aria-describedby="datatable-buttons_info" >
                      <thead>
						...
						<th class="sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 50px;" aria-sort="ascending" aria-label="Name: activate to sort column descending">الكود</th>
						<th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 50px;" aria-label="Position: activate to sort column ascending">البطاقة الالكترونية</th>
						<th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 100px;" aria-label="Office: activate to sort column ascending">البطاقة القومية</th>
						<th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 150px;" aria-label="Age: activate to sort column ascending">تاريخ الايداع</th>
						<th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 115px;" aria-label="Start date: activate to sort column ascending">كود البائع</th>
						<th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 89px;" aria-label="Salary: activate to sort column ascending">الايميل الخاص بك</th></tr>
                      </thead>
...
$infa=mysql_query('SELECT * from codenter WHERE email="'.$ema.'"');
  ...
  <tr role="row" class="odd">
                          <td><?php echo $nmm; ?></td>
                          <td tabindex="0" class="sorting_1"><?php echo $getin['coden']; ?></td>
                          <td><?php echo $getin['cardnum']; ?></td>
                          <td><?php echo $getin['idper']; ?></td>
                          <td><?php echo $getin['tim']; ?></td>
                          <td><?php echo $userRow['userId']; ?></td>
					      <td><?php echo $getin['email']; ?></td>
                        </tr>
  <?php } ?>
