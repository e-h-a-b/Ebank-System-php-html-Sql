                  ...
                  <div class="x_content" style="display: block;width: 100%;">
                    ...
                    <div class="col-md-8 col-lg-8 col-sm-7">
                      ...
                      <blockquote class="blockquote-reverse">
                        <p>هذا الشريط يخبرك دوما بالاعداد  رصيدك رصيد البنك عدد الاعضاء عدد المشروعات اينما كنت فى الموقع فانه يخبرك بالاقام دوما</p>
...
<p>الصفحة الشخصية وهى تشتمل على بيانات اذا اردت ان تحجب بياناتك او تعرضها فاذهب للصفحة الشخصية</p>
<p>اذا اردت ان تطلع على اخر بيانات المشروعات وميزانيتك  والاشتراك بالمشروعات فاذهب للصفحة العامة</p><p>المشروعات المشترك بها تعرض لك كافة المشروعات التى اشتركت بها بالتفصيل</p>
<p>احصائيات الارباح السنوية تعرض لك كل ارباحك الشهرية والسنوية لكل مشروع تم به </p>
<p>الملف الشخصي هو الملف الخاص بك يحتوى على كافة بياناتك وهى مشفرة داخل قاعدة البيانات</p>

<p>الاصدقاء يمكنك اضافة اصدقاء الى القائمة وهى تظهر لك فقط</p><p>ادخل المبلغ
  <i font-size="10px;">لكى تقوم بادخال المبلغ  عبر الارقام المعطاه من قبل البائع</i>
</p>
                        <footer>Someone famous in <cite title="Source Title">Source Title</cite>
                        </footer>
                      </blockquote>
