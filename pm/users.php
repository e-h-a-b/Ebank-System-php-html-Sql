...
$req = mysql_query('select userId, userName, userEmail from users');
while($dnn = mysql_fetch_array($req))
{
?>
	<tr>
    	<td class="left"><?php echo $dnn['userId']; ?></td>
    	<td class="left"><a href="profile.php?id=<?php echo $dnn['userId']; ?>"><?php echo htmlentities($dnn['userName'], ENT_QUOTES, 'UTF-8'); ?></a></td>
    	<td class="left"><?php echo htmlentities($dnn['userEmail'], ENT_QUOTES, 'UTF-8'); ?></td>
    </tr>
<?php
}
?>
